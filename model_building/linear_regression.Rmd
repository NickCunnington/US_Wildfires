...
**As 0 occurs within the 95% confidence intervals of -283 to +1075 it reinforces the fact that this model can not be used to explain if there are any positive or negative trends that are occurring in this data.  It will be more use to use a model that is designed for time series and seasonal variations (see SARIMA model workbook).  For that I shall be also requiring more data points so I will now use monthly data and not yearly.**
